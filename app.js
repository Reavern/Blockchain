...
class Block {
	...
	generate_block_hash() {
		...
		const hashedBlock = crypto.createHmac('sha256', toBeHashed).update('Ini Hash').digest('hex');		
		return hashedBlock;
	}
...
const FarellChain = new Blockchain();

var blockbaru = FarellChain.generate_next_block("TEST");
FarellChain.add_new_block(blockbaru);
blockbaru = FarellChain.generate_next_block("AAAA");
FarellChain.add_new_block(blockbaru);
console.log(FarellChain);
var bool = FarellChain.is_all_block_valid();